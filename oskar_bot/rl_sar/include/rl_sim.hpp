...
private:
    ...
    geometry_msgs::msg::Twist scaled_cmd_vel;  // ★★★★★ 추가: 스케일된 cmd_vel 저장용 ★★★★★
    ...
    geometry_msgs::msg::Twist ScaleVelocity(const geometry_msgs::msg::Twist& original_cmd);  // ★★★★★ 추가: 스케일링 함수 ★★★★★
    ...
    bool simulation_running = true;  // ★★★★★ 추가: 시뮬레이션 상태 관리용 ★★★★★
    int motiontime = 0;
